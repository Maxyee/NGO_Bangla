...
class SettingController extends Controller
{
    ...
    public function UpdateSEO(Request $request,$id)
    {
		  ...
		  $data['client1_name']=$request->client1_name;
		  $data['client2_name']=$request->client2_name;
		  $data['client3_name']=$request->client3_name;
		  $data['client4_name']=$request->client4_name;
		  $data['client5_name']=$request->client6_name;
		  $data['client1_testimonial']=$request->client1_testimonial;
		  $data['client2_testimonial']=$request->client2_testimonial;
		  $data['client3_testimonial']=$request->client3_testimonial;
		  $data['client4_testimonial']=$request->client4_testimonial;
		  $data['client5_testimonial']=$request->client5_testimonial;
		  $data['client6_testimonial']=$request->client6_testimonial;
		  $data['client6_name']=$request->client6_name;
...
//important website
    ...
    public function UpdateWebsite(Request $request,$id)
    {
		   ...
		   $data['complite_project']=$request->complite_project;
		   $data['running_project']=$request->running_project;
		   $data['upcomeing_project']=$request->upcomeing_project;
		   $data['satisfied_qualification']=$request->satisfied_qualification;
		   ...
		   $data['president_tittle']=$request->president_tittle;
		   $data['genarelsecretr_tittle']=$request->genarelsecretr_tittle;
		   $data['president_short']=$request->president_short;
		   $data['president_long']=$request->president_long;
		   $data['genarelsecretr_short']=$request->genarelsecretr_short;
		   $data['genarelsecretr_long']=$request->genarelsecretr_long;
		   $data['embition']=$request->embition;
           $image=$request->logo;
           if ($image) {
		   ...
		   $image=$request->brand1_logo;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(270,118)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['brand1_logo']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
		   ...
		   $image=$request->brand2_logo;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(270,118)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['brand2_logo']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
            ...
            return Redirect()->back()->with($notification);
		   		   ...
		   		   $image=$request->brand3_logo;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(270,118)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['brand3_logo']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
            ...
            return Redirect()->back()->with($notification);
		   		   ...
		   		   $image=$request->brand4_logo;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(270,118)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['brand4_logo']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
           ...
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(1000,350)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
