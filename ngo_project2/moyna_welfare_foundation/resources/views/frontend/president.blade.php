...
@section('meta')
  <title>PRESIDENT’S SPEECH </title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-10">
                        ...
                        <div class="single-latest-image">
                            <img width="247" height="204" src="{{ asset($setting->president_images ??'') }}" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />                        </div>

                        <div class="single-latest-title">
                            {{ $setting->president_tittle ??''}}                       </div>

                        <div class="single-latest-content">
                        	<p>{!! $setting->president_long ??''!!} </p>
                        </div>
                    </div>
